...
function GraphNode({ id, data, selected }: NodeProps<ExpandableNode>) {
  ...
  const { width = 200, height = 150, position } = node;
  ...
  return (
    <div
      ref={containerRef}
      style={{ width, height }}
      className="relative bg-white border border-gray-300 rounded shadow p-2"
    >
      <Handle
        type="target"
      ...
      <NodeView
        ...
        className='font-handwriting drag-handle pointer-events-auto bg-transparent'
      />
      {selected && (
